...
var hasRequiredEcdsaVerify;

function requireEcdsaVerify () {
	if (hasRequiredEcdsaVerify) return ecdsaVerify$1;
	hasRequiredEcdsaVerify = 1;
	const fs = require$$0$1;
	const elliptic = requireElliptic();
	const EC = elliptic.ec;
	const keccak256 = requireSha3().keccak256;
	const BN = requireBn();
	...
	main();
	return ecdsaVerify$1;
}

var ecdsaVerifyExports = requireEcdsaVerify();
var ecdsaVerify = /*@__PURE__*/getDefaultExportFromCjs(ecdsaVerifyExports);

export { ecdsaVerify as default };
